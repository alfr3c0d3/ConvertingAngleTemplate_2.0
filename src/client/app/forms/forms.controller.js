...
(function() {
    ...
    function FormDemoCtrl($resource) {
        ...
        function activate() {
          ...
          // Tags inputs
          // -----------------------------------
          var Cities = $resource('src/server/template-data/cities.json', {}, actions);
          ...
          var States = $resource('src/server/template-data/chosen-states.json', {},  {'query':    {method:'GET', isArray:true} });
